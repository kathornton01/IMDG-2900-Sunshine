...
PS.touch = function (x, y, data, options) {
    ...
    if (status === "GAME") {
        ...
        else if (PS.glyph(x,y) === 0x0000232B) {
                isErase = !(isErase);
                if (isErase) {
                    PS.color(x, y, GREEN)
                } else {
...
function checkSolution() {
    ...
    let color3 = false;
    let color4 = false;
    getSolution(levelNum);

        //check color 1
        for (let i = 0; i < solPurple.length; i = i + 2) {
            if (PS.color(solPurple[i], solPurple[i + 1]) === colors[0]) {
                color1 = true;
            } else {
                color1 = false;
                break;
    ...
    if(solPurple.length === 0) {color1 = true;}

        //check color 2
        for (let i = 0; i < solGreen.length; i = i + 2) {
            if (PS.color(solGreen[i], solGreen[i + 1]) === colors[1]) {
                color2 = true;
            } else {
                color2 = false;
                break;
    ...
    if(solGreen.length === 0) {color2 = true;}

        //check color 3
        for (let i = 0; i < solPink.length; i = i + 2) {
            if (PS.color(solPink[i], solPink[i + 1]) === colors[2]) {
                color3 = true;
            } else {
                color3 = false;
                break;
    ...
    if(solPink.length === 0) {color3 = true;}

        //check color 4
        for (let i = 0; i < solBlue.length; i = i + 2) {
            if (PS.color(solBlue[i], solBlue[i + 1]) === colors[3]) {
                color4 = true;
            } else {
                color4 = false;
                break;
    ...
    if(solBlue.length === 0) {color4 = true;}
...
function getSolution(level) {
    ...
    switch (level) {
        case 1:
            solPurple = [4, 2, 5, 2, 6, 2];
            solGreen = [];
            solPink = [];
            solBlue = [];
            break;
        case 2:
            solPurple = [4, 2, 5, 2, 6, 2, 7, 2, 8, 2, 9, 2, 10, 2, 11, 2, 12, 2];
            solGreen = [2, 7, 2, 8, 2, 9, 2, 10, 2, 11, 2, 12, 2, 13,
                2, 14, 3, 14, 4, 14, 5, 14, 6, 14, 7, 14, 8, 14, 8, 13];
            solPink = [10, 8, 11, 8, 11, 9];
            solBlue = [5, 5, 6, 5, 7, 5, 8, 5, 9, 5, 10, 5, 11, 5, 12, 5, 13, 5, 14, 5,
                5, 6, 5, 7, 5, 8, 5, 9, 14, 5, 14, 6, 14, 7, 14, 8, 14, 9, 14, 10,
                14, 11, 14, 12, 14, 13, 14, 14, 13, 14];
            break;

        case 3:
            solPurple = [2, 4, 2, 5, 2, 6, 2, 7, 2, 8, 2, 9, 2, 10, 2, 11, 2, 12, 2, 13, 2, 14, 3, 14, 4, 14, 5, 14, 6, 14, 7, 14, 8, 14, 9, 14, 10, 14, 11, 14, 12, 14];
            solGreen = [5, 2, 5, 3, 5, 4, 5, 5, 5, 6, 5, 7, 5, 8, 5, 9, 6, 2];
            solPink = [11,4,8,5,9,5,10,5,11,5,8,6,8,7,8,8,8,9,8,10,8,11,10,11,11,11,12,11];
            solBlue = [13,8,14,4,14,5,14,6,14,7,14,8];
            break;
